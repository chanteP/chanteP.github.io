	...
	var page = {
		...
		*/
		'show' : function(pageName, oldPageName){
			oldPageName && require.async(pageModulePrefix + oldPageName, function(){
...
// 			}
			...
			pageName && require.async(pageModulePrefix + pageName, function(){
	...
	vm.init = function(){
		vm.ob('page', page.check);
	}
	window.setPage = page.rel;
